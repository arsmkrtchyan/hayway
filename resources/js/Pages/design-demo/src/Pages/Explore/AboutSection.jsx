...
const FEATURE_ITEMS = [
    {
        ...
        extra:
            "Վարորդների անձնական տվյալների ստուգում, մեքենայի փաստաթղթերի վավերացում և support 24/7․",
    },
    {
        icon: Clock,
        title: "Արագություն",
        ...
        extra:
            "Smart match դեպի ամենամոտ վարորդ, push notification-ներ և ուղու live թարմացում քարտեզի վրա։",
    },
    {
        icon: MapIcon,
        title: "Ճանապարհ",
        ...
        extra:
            "Խելացի meet-point ընտրություն, միջանկյալ կանգառներ և ուղու օպտիմալացում ըստ ժամանակի ու գնի։",
    },
    {
        icon: Star,
        title: "Վարկանիշներ",
        ...
        extra:
            "Վարորդի և ուղևորի պատմություն, review-ների ֆիլտր և խնդիրների արագ լուծում support թիմի կողմից։",
    },
]

const AVG_RATING = 4.8
const TOTAL_REVIEWS = 320
const TOTAL_REVIEWS_LABEL = TOTAL_REVIEWS.toLocaleString("hy-AM")
        ...
        <section className="mt-16 mb-10">
            <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <p className="mt-1 text-sm text-slate-600">
                    Պլատֆորմ, որը միավորում է տաքսիի արագությունը և համատեղ ուղևորության գինը։
                </p>
                ...
                <div className="mt-6">
                    <div className="relative overflow-hidden rounded-[32px] border border-cyan-100 bg-white/95 px-6 py-6 shadow-[0_22px_55px_rgba(34,197,235,0.28)] backdrop-blur-xl sm:px-8 sm:py-7">
                        <div
                            aria-hidden
                            className="pointer-events-none absolute inset-0 opacity-60 bg-[radial-gradient(circle_at_top_left,rgba(56,189,248,0.22),transparent_55%),radial-gradient(circle_at_bottom_right,rgba(16,185,129,0.18),transparent_55%)]"
                        />
                        ...
                        <div className="relative z-10 flex flex-col gap-6 md:flex-row md:items-start">
                            <div className="flex-1 space-y-2">
                                <p className="text-xs font-semibold uppercase tracking-[0.15em] text-emerald-600">
                                    Հարմար, անվտանգ ճանապարհորդություն
                                </p>
                                <p className="text-lg font-semibold text-slate-900 sm:text-xl">
                                    Գտի՛ր մեքենա Հայաստանի քաղաքների միջև՝ մի քանի սեղմումով։
                                </p>
                                <p className="max-w-xl text-[13px] leading-relaxed text-slate-600">
                                    HayWay-ը օգնում է արագ գտնել ուղևորություն, ընտրել meet-point, տեսնել
                                    վարորդի վարկանիշները և կիսել ճանապարհի արժեքը մյուս ուղևորների հետ։
                                </p>
                            </div>
                            ...
                            <div className="flex shrink-0 items-center gap-4 md:flex-col md:items-end">
                                <div className="text-right">
                                    ...
                                    <div className="text-[11px] text-slate-500">
                                        {TOTAL_REVIEWS_LABEL}+ կարծիք պլատֆորմի շուրջ
                                    </div>
                                </div>
                        ...
                        <div className="relative z-10 mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                            {FEATURE_ITEMS.map(({ icon: Icon, title, text, extra }) => (
                                <article
                                    key={title}
                                    className="group flex h-full flex-col rounded-2xl border border-cyan-100 bg-cyan-50/80 p-4 text-left shadow-sm transition hover:border-emerald-300 hover:bg-white hover:shadow-[0_18px_40px_rgba(34,197,235,0.45)]"
                                >
