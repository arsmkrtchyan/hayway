...
//         let label = point.addr;
//         if (!label) {
//             label = await reverseGeocodeNominatim(point.lng, point.lat);
//         }
//         setSearch((prev) => ({
//             ...prev,
...
//             <div className="text-xl font-semibold text-slate-900">Ընտրված պայմաններով ուղևորություններ մինչ այժմ չեն գտնվել</div>
...
//             </div>
//             <button className="rounded-full border border-emerald-500 px-5 py-2 text-sm font-semibold text-emerald-700 hover:bg-emerald-500/10">
//                 Ստեղծել հիշեցում
//             </button>
//         </div>
//     );
